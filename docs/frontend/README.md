...
A Next.js Web3 application for managing Work Proof NFTs and building professional reputation, generated by [N]skills.
...
- ✅ Work Proof NFT minting and management
- ✅ Freelancer reputation dashboard
...
The frontend includes components for interacting with the Work Proof NFT contract:

### Components

- **WorkProofInteractionPanel**: Main interface for minting and viewing work proofs
- **WalletButton**: RainbowKit wallet connection
- **FreelancerDashboard**: Display freelancer's work history and ratings

### Contract Integration

The Work Proof contract provides these key functions:

```ts
// Mint new work proof (client only)
...
const workProofs = await contract.get_freelancer_tokens(freelancerAddress);
...
export default function Home() {
  return (
    <div>
      <h1>Freelance Reputation Platform</h1>
...
| `NEXT_PUBLIC_NFT_ADDRESS` | No | Deployed Work Proof contract address |

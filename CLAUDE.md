...
```mermaid
graph TD
  2e71cf51["ERC-721 NFT"]
  74c20f50["Frontend"]
  e641bde6["Wallet Auth"]
  2e71cf51 --> 74c20f50
  74c20f50 --> e641bde6
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--2e71cf51.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--74c20f50.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--e641bde6.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--2e71cf51.md)
- [Frontend](.nskills/components/frontend-scaffold--74c20f50.md)
- [Wallet Auth](.nskills/components/wallet-auth--e641bde6.md)
